...
<aside class="aside">
				...
				<nav class="menu text-menu">
					...
					<ul>
						...
						<li><a class="active" href="/student/helpdesk/question">1:1
								수강문의 및 답변확인</a></li>
				...
				<nav class="menu">
					...
					<ul>
						...
						<li><a target="_blank" href="http://www.hanbit.co.kr/"><img
								src="../../../images/hanbit.png" alt="한빛미디어" /></a></li>
						<li><a target="_blank" href="http://acornacademy.co.kr/"><img
								src="../../../images/acorn.png" alt="에이콘아카데미" /></a></li>
						<li><a target="_blank" href="http://www.sist.co.kr"><img
								src="../../../images/sist.png" alt="쌍용교육센터" /></a></li>
